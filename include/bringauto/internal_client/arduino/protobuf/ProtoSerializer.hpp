...
public:
	 ...
	 */
	static int serializeInternalClientMessageToBuffer(InternalProtocol_InternalClient &internalClientMessage, buffer *buffer);
	 ...
	 */
	static int checkConnectResponse(const String &internalServerConnectResponse, const InternalProtocol_Device& device);
	 ...
	 */
	static int checkAndParseCommand(String &command, const String &internalServerCommand,
